...
import { ProviderCard, type ProviderData } from "./provider-card";
import { CategoryFilter } from "./category-filter";
import { ProviderDialog } from "./provider-dialog";
import { deleteServiceProvider } from "@/lib/actions/service-providers";
...
type ProviderDirectoryClientProps = {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-1">
            Find trusted service providers for your practice
          </p>
        </div>
        {isSuperAdmin && (
