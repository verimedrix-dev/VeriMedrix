...
import { createServiceProvider, updateServiceProvider } from "@/lib/actions/service-providers";
import type { ProviderData } from "./provider-card";
...
export function ProviderDialog({
  ...
  // Reset form when dialog opens with different provider
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editProvider) {
        await updateServiceProvider(editProvider.id, payload);
