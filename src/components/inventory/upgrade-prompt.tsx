...
export function UpgradePrompt() {
  const features = [
    ...
    "Monitor expiry dates for medicines and consumables",
    "Record stock movements (in/out) with full audit trail",
      ...
      <Card className="max-w-lg w-full">
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription className="text-base">
            Keep track of your practice&apos;s stock, supplies, and expiry dates with comprehensive inventory management.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-lg p-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Available on the OHSC Professional plan. Upgrade to access Inventory Management and other premium features.
            </p>
          </div>
